...
- `thought_changes`: what changed since a time or a cursor — every capture, edit and deletion, who made it, and what moved (this fork's `server-portable` server only, migration 050).
