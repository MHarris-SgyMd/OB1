...
| [Obsidian Vault Import](db/README.md#the-stable-tier--a-brain-rebuilt-from-the-records-smd-1806) | Retired (SMD-2137) — on this fork the import is core: `bun db/ingest-records.ts --source markdown --markdown <vault> --allow <vault>`, then `bun db/reembed.ts` | — |
