...
Landed since the last release and numbered at the next one (SMD-1804): [SMD-1296](changes/smd-1296.md), [SMD-1875](changes/smd-1875.md), [SMD-1982](changes/smd-1982.md).
<!-- changes-index:end -->
