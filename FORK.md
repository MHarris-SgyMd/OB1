...
(change 11).
### 53. A pass that proposes which thoughts supersede which — reviewed one at a time, never applied unreviewed (SMD-1294)
...
Rejecting an accepted proposal undoes its write while it still stands. A
