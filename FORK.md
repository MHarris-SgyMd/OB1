...
Landed since the last release and numbered at the next one (SMD-1804): [SMD-1296](changes/smd-1296.md), [SMD-1982](changes/smd-1982.md), [SMD-2012](changes/smd-2012.md).
<!-- changes-index:end -->
