...
Landed since the last release and numbered at the next one (SMD-1804): [SMD-1298](changes/smd-1298.md), [SMD-1809](changes/smd-1809.md), [SMD-1989](changes/smd-1989.md).
<!-- changes-index:end -->
