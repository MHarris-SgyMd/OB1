...
Landed since the last release and numbered at the next one (SMD-1804): [SMD-1296](changes/smd-1296.md), [SMD-1713](changes/smd-1713.md), [SMD-1982](changes/smd-1982.md), [SMD-1998](changes/smd-1998.md).
<!-- changes-index:end -->
