...
ask; a lower-case key in an ask counts only for a team the session's branches
name. A compaction and a move between two asks are both recorded. Work
...
474 assertions (from 414), three runs: the ticket-key shape and what it is
