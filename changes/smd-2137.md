...
3. `docs/vendored-disposition.md`: the PostgREST-scripts row and the rollup's
   ...
   `POSTGREST_EXCEPTIONS` as the remaining size; the SMD-1924 inventory row
...
| 1 | five check mutants (entry back, connector back, marker back, a table cell hand-edited, the directory restored untracked) each killed by the named rule | mutant | — |
