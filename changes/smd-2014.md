...
assertions (from 484, extended across the five review passes): the egress rule (local declared not guessed; deny, allow,
...
(real Postgres, 224 assertions): a caller `metadata.summary_model` stored beside
