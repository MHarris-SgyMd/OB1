...
`bun test-schema.ts` prints `135 assertions: 135 passed, 0 failed` and `PASS`.
...
```bash
bun test-schema.ts                    # 135 assertions, PGlite, no container
...
asserts 135 properties, including:
