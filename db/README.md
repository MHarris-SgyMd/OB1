...
`bun test-schema.ts` prints `504 assertions: 504 passed, 0 failed` and `PASS`.
...
```bash
bun test-schema.ts                    # 504 assertions, PGlite, no container
...
asserts 504 properties, including:
