...
| source | what | needs |
| --- | --- | --- |
| `fork` | FORK.md's numbered `### N.` change sections | in the tree |
...
./with-postgres.sh bun test-live.ts         # 593 assertions, real server, throwaway container (fewer, as one skipped group, on PostgreSQL 18 or without JIT)
