 ...
 * `1.2.0` the third (052..057, a minor: five additive migrations);
 ...
 * exact string (057 today); check-fork's 17d holds the two equal, and
 * scripts/assemble-release.ts refuses --write until both say the version.
 */
export const FORK_VERSION = `1.2.0+upstream.${UPSTREAM_PIN}`;
...
function selfCheck() {
  ...
  bad += eq(sign(semverCompare("1.2.0", FORK_VERSION)), 0, "FORK_VERSION core is 1.2.0 (the third release)");
