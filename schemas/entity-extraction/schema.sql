...
-- five tables (SELECT, INSERT, UPDATE, DELETE; thought_entities without
-- UPDATE — it is 016's table on a migrated brain, so 016's grant exactly) and the three bigserial
