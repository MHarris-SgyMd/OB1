...
>
> ```bash
> SUPABASE_URL='postgres://user:password@host:5432/openbrain' READWISE_WEBHOOK_SECRET='…' READWISE_ACCESS_TOKEN='…' OPENROUTER_API_KEY='…' bun integrations/readwise-capture/index.ts
> ```
>
