...
// ob1-fork (SMD-1524): this pattern writes `thoughts` with a raw insert, by design — its
...
// Listed in scripts/check-fork-consistency.ts check 10's exceptions (FORK.md change 71).
/**
