...
// SMD-1726: who wrote a thought's current text, on the read path. Migration 047
 ...
 * are the keys migration 047 stamps, so the store, the query log and the plan
 ...
 * migration 047 stamps. Absent when the row carries neither (a write from
      ...
      try {
        ...
        const results = data.map(
          (t, i) => {
            ...
            // SMD-1726: who wrote the current text, from the key (047); its own
  ...
  server.registerTool(
    "list_thoughts",
    {
      ...
      inputSchema: {
        ...
        // SMD-1726: who wrote it — the two keys 047 stamps, as containment
