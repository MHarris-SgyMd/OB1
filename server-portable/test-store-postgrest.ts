...
console.log("\n[14] listChanges over PostgREST: the rpc shape — every argument named, the actions as text[] through the shim's catalog read, the row normalised (migration 051, SMD-1296)");
{
  const admin = new SQL({ url: URL_, max: 1 });
