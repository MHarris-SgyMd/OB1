...
console.log("[1] captureThought without chunks — the 3-arg RPC, unchanged");
{
  ...
  assert(again.id === id && again.existed === true && again.supersedes === null, "a re-capture over PostgREST reports existed: true and supersedes: null — the keys rides the RPC's return");
