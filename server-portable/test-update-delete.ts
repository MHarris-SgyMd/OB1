...
// refuses every call to it. test-egress.ts holds that case. (CI caught this
// suite, the one the change's local run had not exercised: BSD grep reads
// this file as binary, so it was missing from the list of suites that name
// the provider.)
