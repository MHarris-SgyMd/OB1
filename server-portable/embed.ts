...
export type EmbedConfig = {
  ...
  /** The model's listed context holds no window at all beside the rules and an answer; the default is in force and preflight warns. */
  extractChunkTokensUnfit: boolean;
