...
> **Already have your brain's connection string from the [Setup Guide](../../docs/01-getting-started.md)?** That is the one value this server needs from it, plus an access key — reuse one from your core setup or mint one for this server.
